...
const ListadoEmpanadas = ({ listadoEmpanadas }) => {

    const [loading, setLoading] = useState(true);

    useEffect(() => {
        setLoading(!listadoEmpanadas || listadoEmpanadas.length === 0);
    }, [listadoEmpanadas]);
    console.log('listadoEmpanadas en ListadoEmpanadas', listadoEmpanadas);
    console.log('loading en ListadoEmpanadas', loading);
...
export default ListadoEmpanadas;
